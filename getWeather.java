                    ...
                    JsonObjectRequest request=new JsonObjectRequest(Request.Method.GET, server_url, null, new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                String status=region+" "+country+" "+temp_c+" "+text+" "+maxtemp_c[0]+" "+mintemp_c[0]+" "+avgtemp_c[0]+" "+maxtemp_c[1]+ " "+mintemp_c[1]+" "+avgtemp_c[1]+" "+maxtemp_c[2]+" "+mintemp_c[2]+" "+avgtemp_c[3]+" "+maxtemp_c[3]+" "+mintemp_c[3]+" "+avgtemp_c[4]+" "+maxtemp_c[4]+ " "+mintemp_c[4]+" "+avgtemp_c[5]+" "+maxtemp_c[5]+" "+mintemp_c[5]+" "+avgtemp_c[6]+" "+maxtemp_c[6]+" "+mintemp_c[6];
